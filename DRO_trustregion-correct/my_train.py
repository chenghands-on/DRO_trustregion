...
# from pydrsom_update.drsom import DRSOMB as DRSOM
# from pydrsom_update.drsom_utils import *
...
def make_args():
    ...
    # parser.add_argument('--option_tr',default="a",type=str)
...
def main(args):
    ...
    file_name = args.optim + '_draft.csv'
