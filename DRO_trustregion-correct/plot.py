...
path1='/nfsshare/home/lichenxi/DRO/DRO_trustregion-correct/sgd.csv'
path2='/nfsshare/home/lichenxi/DRO/drsom.csv'
...
plt.title('')
plt.plot(np.arange(1, epsoids + 1), sgd['all_avg_mae'], label='sgd')
